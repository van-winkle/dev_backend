...
class IncidentsResolutionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('pho_phone_resolutions')->insert([
            ['title' => 'Me huertaron el phon', 'reply' => 'lorem imsupm','pho_phone_incident_id'=>2, 'adm_employee_id'=>1],
            ...
            ['title' => 'Me huertaron el on fire', 'reply' => 'lorem imsupm','pho_phone_incident_id'=>1, 'adm_employee_id'=>2],
        ]);
    }
}
